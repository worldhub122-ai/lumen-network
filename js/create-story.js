document.addEventListener('DOMContentLoaded', function(){
  ...
  /* ============================================================
     DROPZONE (photo or video upload + preview)
     ============================================================ */
  ...
  if(form){
    form.addEventListener('submit', (e)=>{
      ...
      const d = dict();
      if(!hasMedia){
        showToast(d.chooseMediaFirst || 'Choose a photo or video first.');
        return;
      }
      submitBtn.disabled = true;
      submitBtn.querySelector('span').textContent = d.addingStoryLabel || 'Adding…';
      setTimeout(()=>{
        submitBtn.disabled = false;
        submitBtn.querySelector('span').textContent = d.storySubmitBtn || 'Add to story';
