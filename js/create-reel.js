document.addEventListener('DOMContentLoaded', function(){
  ...
  if(form){
    form.addEventListener('submit', (e)=>{
      ...
      submitBtn.querySelector('span').textContent = d.publishingLabel || 'Publishing…';
      setTimeout(()=>{
        submitBtn.disabled = false;
        submitBtn.querySelector('span').textContent = d.reelSubmitBtn || 'Publish reel';
