document.addEventListener('DOMContentLoaded', function(){
  ...
  /* ============================================================
     RATING BADGE (matches post/profile/login meter styling)
     ============================================================ */
  ...
  const photoDefaultHTML = photoPreview ? photoPreview.innerHTML : '';
  ...
  if(photoInput){
    photoInput.addEventListener('change', ()=>{
      ...
      if(file.size > 5 * 1024 * 1024){
        showToast('That image is over 5MB — pick a smaller file.');
        photoInput.value = '';
        return;
      }
      ...
      reader.onload = (e)=>{
        ...
        photoRemove.classList.add('visible');
      };
  ...
  if(photoRemove){
    photoRemove.addEventListener('click', ()=>{
      photoInput.value = '';
      photoPreview.innerHTML = photoDefaultHTML;
      photoRemove.classList.remove('visible');
    });
  }
  ...
  function checkMatch(){
    ...
    return matches || confirmField.value === '';
  }
  ...
  if(form){
    form.addEventListener('submit', (e)=>{
      ...
      submitBtn.querySelector('span').textContent = d.creatingAccount || 'Creating account…';
      setTimeout(()=>{
        submitBtn.disabled = false;
        submitBtn.querySelector('span').textContent = d.createAccountBtn || 'Create account';
